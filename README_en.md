...
| Qoder | Run `qodercli plugin install <path-to-repo>` | Restart Qoder or start a new conversation and choose an entry from the `/` menu | Run `qodercli plugin uninstall asu-skills` |
